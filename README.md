...
| mihomo  | `mihomo`  | VLESS / VMess / Trojan / Shadowsocks / Hysteria2 / TUIC | Shared-credential listener per inbound; user-level isolation via the forward layer. Hysteria2 / TUIC use UDP forward rules. Tracks MetaCubeX/mihomo Alpha |
