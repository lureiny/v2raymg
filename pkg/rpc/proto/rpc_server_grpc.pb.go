...
func (UnimplementedEndNodeAccessServer) ResetUser(context.Context, *UserOpReq) (*UserOpRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method ResetUser not implemented")
}
...
func (UnimplementedEndNodeAccessServer) GetBandWidthStats(context.Context, *GetBandwidthStatsReq) (*GetBandwidthStatsRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBandWidthStats not implemented")
}
...
func (UnimplementedEndNodeAccessServer) SetGatewayModel(context.Context, *SetGatewayModelReq) (*SetGatewayModelRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method SetGatewayModel not implemented")
}
func (UnimplementedEndNodeAccessServer) SetPingCheck(context.Context, *SetPingCheckReq) (*SetPingCheckRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method SetPingCheck not implemented")
}
...
func (UnimplementedEndNodeAccessServer) DeleteInbound(context.Context, *InboundOpReq) (*InboundOpRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteInbound not implemented")
}
func (UnimplementedEndNodeAccessServer) TransferInbound(context.Context, *TransferInboundReq) (*InboundOpRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method TransferInbound not implemented")
}
func (UnimplementedEndNodeAccessServer) CopyInbound(context.Context, *CopyInboundReq) (*InboundOpRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method CopyInbound not implemented")
}
func (UnimplementedEndNodeAccessServer) CopyUser(context.Context, *CopyUserReq) (*InboundOpRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method CopyUser not implemented")
}
...
func (UnimplementedEndNodeAccessServer) UpsertClusterUsers(context.Context, *UpsertClusterUsersReq) (*UpsertClusterUsersRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method UpsertClusterUsers not implemented")
}
...
func RegisterEndNodeAccessServer(s grpc.ServiceRegistrar, srv EndNodeAccessServer) {
	// If the following call panics, it indicates UnimplementedEndNodeAccessServer was
...
func (UnimplementedCenterNodeAdminServer) GetCluters(context.Context, *GetClutersReq) (*GetClutersRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCluters not implemented")
}
...
func RegisterCenterNodeAdminServer(s grpc.ServiceRegistrar, srv CenterNodeAdminServer) {
	// If the following call panics, it indicates UnimplementedCenterNodeAdminServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterCenterNodeAccessServer(s grpc.ServiceRegistrar, srv CenterNodeAccessServer) {
	// If the following call panics, it indicates UnimplementedCenterNodeAccessServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
