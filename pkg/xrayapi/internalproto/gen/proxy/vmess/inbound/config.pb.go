...
const file_proxy_vmess_inbound_config_proto_rawDesc = "" +
	...
	"\adefault\x18\x02 \x01(\v2'.xray.proxy.vmess.inbound.DefaultConfigR\adefaultB\x89\x01\n" +
	"\x1ccom.xray.proxy.vmess.inboundP\x01ZLgithub.com/lureiny/v2raymg/pkg/xrayapi/internalproto/gen/proxy/vmess/inbound\xaa\x02\x18Xray.Proxy.Vmess.Inboundb\x06proto3"
